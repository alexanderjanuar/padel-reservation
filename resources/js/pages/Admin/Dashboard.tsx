        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-8 p-4 md:p-8">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-indigo-200 hover:shadow-md">
                        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 opacity-30">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart
                        ...
                        <div className="absolute top-0 right-0 -mt-4 -mr-4 rounded-full bg-indigo-50/50 p-8 transition-transform group-hover:scale-110">
                            <CalendarDays className="h-6 w-6 text-indigo-500 opacity-50" />
                        </div>
                        <div className="relative z-10">
                            <div className="mb-3 flex items-center justify-between text-slate-500">
                                <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex flex-col items-center gap-3 sm:flex-row">
                            ...
                            <div className="relative w-full sm:w-64">
                                ...
                                <input
                                    type="text"
                                    className="block w-full appearance-none rounded-xl border-0 bg-slate-50/50 py-2 pr-3 pl-9 text-sm text-slate-900 ring-1 ring-slate-200 ring-inset placeholder:text-slate-400 focus:ring-2 focus:ring-indigo-600 focus:ring-inset"
                            ...
                            <div className="relative flex w-full items-center gap-2 sm:w-auto">
                                ...
                                <select
                                    ...
                                    className="block w-full cursor-pointer appearance-none rounded-xl border-0 bg-slate-50/50 py-2 pr-10 pl-3 text-sm text-slate-900 ring-1 ring-slate-200 ring-inset focus:ring-2 focus:ring-indigo-600 focus:ring-inset"
                                >
