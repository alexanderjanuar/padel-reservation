...
export default function Dashboard({
    ...
    const getStatusBadge = (status: Booking['status']) => {
        ...
        return (
            <span
                className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-semibold ring-1 ring-inset ${styles[status]}`}
            >
                {labels[status]}
            </span>
        );
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex h-full w-full max-w-7xl flex-1 flex-col gap-8 overflow-x-hidden p-4 md:p-8">
                {/* ═══════════ 1. Welcome Hero Section ═══════════ */}
                <div className="relative overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-900 px-8 py-12 shadow-xl md:p-16">
                    ...
                    <div className="pointer-events-none absolute -right-20 -bottom-20 rotate-12 opacity-10">
                        <svg
                            width="400"
                            height="400"
                            viewBox="0 0 100 100"
                    ...
                    <div className="relative z-10 flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between">
                        <div className="max-w-xl">
                            <h1 className="mb-3 font-heading text-4xl font-bold tracking-tight text-white sm:text-5xl">
                                Halo, {auth.user.name.split(' ')[0]}! 👋
                            </h1>
                            <p className="text-lg leading-relaxed font-medium text-slate-300">
                                Siap untuk pertandingan selanjutnya? Temukan
                                lawan, pesan lapangan, dan tingkatkan permainan
                                Anda.
                            </p>
                        </div>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
                        <div className="absolute -top-6 -right-6 rounded-full bg-padel-green/10 p-8 transition-transform group-hover:scale-110">
                    ...
                    {/* Stat Card 2 */}
                    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
                        <div className="absolute -top-6 -right-6 rounded-full bg-blue-50 p-8 transition-transform group-hover:scale-110">
                    ...
                    {/* Stat Card 3 */}
                    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
                        <div className="absolute -top-6 -right-6 rounded-full bg-amber-50 p-8 transition-transform group-hover:scale-110">
                        ...
                        <div className="relative">
                            ...
                            <p className="mt-2 truncate pr-8 text-xl font-bold tracking-tight text-slate-900">
                                {stats.favoriteVenue}
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col gap-6 lg:col-span-2">
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                href="#"
                                className="text-sm font-semibold text-padel-green hover:text-padel-green-dark"
                            >
                                Lihat Semua
                            </Link>
                        </div>
                        ...
                        {upcomingBookings.length > 0 ? (
                            <div className="flex flex-col gap-4">
                                {upcomingBookings.map((booking) => (
                                    <div
                                        key={booking.id}
                                        className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all hover:border-padel-green/30 hover:shadow-md"
                                    >
                                        <div className="flex flex-col sm:flex-row">
                                            {/* Date Block */}
                                            <div className="flex shrink-0 flex-col items-center justify-center border-b border-slate-100 bg-slate-50 p-6 sm:w-32 sm:border-r sm:border-b-0">
                            ...
                            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 py-16 text-center">
                                ...
                                <p className="mt-1 max-w-sm text-sm text-slate-500">
                                    Anda belum memiliki pemesanan lapangan
                                    mendatang. Ayo mulai bertanding!
                                </p>
                                <Link
                                    href={home().url}
                                    className="mt-6 rounded-full bg-white px-6 py-2.5 text-sm font-bold text-slate-900 shadow-sm ring-1 ring-slate-200 transition-all ring-inset hover:bg-slate-50"
                                >
                                    Cari Lapangan
                                </Link>
                            </div>
                                    ...
                                    {pastBookings.map((booking, idx) => (
                                        ...
                                        >
                                            ...
                                            {idx !==
                                                ...
                                                <div className="absolute top-8 -bottom-6 left-4 w-0.5 bg-slate-100"></div>
                                            )}
