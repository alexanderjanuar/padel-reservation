                    ...
                    <>
                        <div className="shrink-0 border-b border-slate-200 px-5 py-4 sm:px-7 sm:py-5">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-slate-500 sm:text-sm">{items.length} lapangan dipilih</p>
                                </div>
                        ...
                        <div className="min-h-0 flex-1 overflow-y-auto">
                            <div className="space-y-4 px-5 py-4 sm:px-7 sm:py-5">
                                <div className="space-y-3 border-b border-slate-200 pb-4 sm:pb-5">
                            {items.map((item, i) => (
                            ...
                            <div className="mb-4 rounded-2xl bg-slate-50 px-4 py-4">
                                ...
                                <div className="mt-3 flex items-baseline justify-between">
                                    ...
                                    <span className="font-display text-xl font-black text-slate-900 sm:text-2xl">{fmt(total)}</span>
                                </div>
                            </div>
                            {error && (
